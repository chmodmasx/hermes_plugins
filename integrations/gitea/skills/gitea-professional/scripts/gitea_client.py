...
class GiteaClient:
    ...
    def __init__(
        ...
        *,
        ...
        user_agent: str = "hermes-gitea-professional/2.0.0",
        max_attempts: int = 4,
    ) -> None:
        if not base_url:
    ...
    def paginate(
        ...
        *,
        ...
        if pages >= max_pages:
            raise GiteaError("E_PAGINATION_LIMIT", f"Exceeded max_pages={max_pages}")
        return {"items": items, "pages": pages, "total_count": total_count}
